...
func newPinger4() Pinger {
    return Pinger{executable: "ping"}
}

func newPinger6() Pinger {
    return Pinger{executable: "ping6"}
}


func (pinger *Pinger) Ping(host string, cnt int, timeout int) PingExecution {
    // Construct the args
    var executable = pinger.executable
    var args []string
